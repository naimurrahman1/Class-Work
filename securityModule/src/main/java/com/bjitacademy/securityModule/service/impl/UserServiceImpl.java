...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public ResponseEntity<Object> register(UserRequestModel requestModel) {
        ...
        UserResponseModel UserResponseModel = new UserResponseModel(requestModel.getUserName(), requestModel.getFirstName(), requestModel.getLastName(), requestModel.getEmail());
